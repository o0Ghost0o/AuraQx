...
class Settings(BaseSettings):
    ...
    jwt_secret_key: str = "auraqx_jwt_master_secret_key_viamatica_aden_2026"
    ...
    cors_origins: List[str] = [
        "https://api-auraqx.vertexdc.com",
        "https://auraqx.vertexdc.com",
        "http://api-auraqx.vertexdc.com",
        "http://auraqx.vertexdc.com",
        "http://localhost:3000",
        "http://127.0.0.1:3000",
        "http://localhost:8000",
        "http://127.0.0.1:8000",
